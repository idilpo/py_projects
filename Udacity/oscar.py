...
for year, directors in nominated.items():
    list_of_directors.append(directors)

flatten_list = []
for sublist in list_of_directors:
    for i in sublist:
        flatten_list.append(i)

for director in flatten_list:
...
for year, director in winners.items():
    list_of_winners.append(director)


flatten_lst = []
for sublist in list_of_winners:
    for i in sublist:
        flatten_lst.append(i)


for director in flatten_lst:
...
most_win_director = []
most_win_director = max(win_count_dict.items(), key=lambda x: x[1])
print('Max value in Dict (count of most awards won): ', most_win_director[1])
print('Key With Max value in Dict (who won the most): ', most_win_director[0])
