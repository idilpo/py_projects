# Imagine you're a teacher who needs to send a message to each of your students reminding them of
# their missing assignments and grade in the class. You have each of their names, number of missing assignments,
...
names = input("Please enter student names: ").title().split(",")
assignments = input("Please enter missing assignment counts (respectively): ").split(",")
grades = input("Please enter students' grades (respectively): ").split(",")
